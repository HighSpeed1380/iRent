module.exports = {
   ...
   "sidebar.companyDetails": "Company Details",
   "sidebar.expenseTypes": "Expense Types",
   "sidebar.journalEntries": "Journal Entries",
   "sidebar.corporateDocs": "Corporate Documents",
   "sidebar.makeReadyTasks": "Make Ready Tasks",
   "sidebar.formCreator": "Form Creator",
   "sidebar.budgetCreator": "Budget Creator",
   "sidebar.glCategories": "GL Categories",
   "sidebar.properties": "Properties",
   "sidebar.viewProperties": "View Properties",
   "sidebar.propertyRules": "Property Rules",
   "sidebar.propertyWizard": "Property Wizard",
   "sidebar.users": "Users",
   "sidebar.viewUsers": "View Users",
   "sidebar.owners": "Owners",
   "sidebar.viewOwners": "View Owners",
   "sidebar.untis": "Units",
   "sidebar.viewUnits": "View Units",
   "sidebar.checkRegister": "Check Register",
   "sidebar.bills": "Bills",
   "sidebar.unpaidBills": "Unpaid Bills",
   "sidebar.paidBills": "Paid Bills",
   "sidebar.recurringBills": "Recurring Bills",
   "sidebar.deposits": "Deposits",
   "sidebar.currentDeposit": "Current",
   "sidebar.depositHistory": "History",
   "sidebar.enterCCPayment": "Enter CC Payment",
   "sidebar.vendors": "Vendors",
   "sidebar.applicants": "Applicants",
   "sidebar.viewProspects": "View Prospects",
   "sidebar.viewApplicants": "View Applicants",
   "sidebar.addApplicant": "Add Applicant",
   "sidebar.deniedApplicants": "Denied Applicants",
   "sidebar.leaseAgreement": "Lease Agreement",
   "sidebar.tenants": "Tenants",
   "sidebar.viewAllTenants": "View All",
   "sidebar.addTenant": "Add",
   "sidebar.previousTenants": "Previous",
   "sidebar.requestConcession": "Request Concession",
   "sidebar.reconcilePreviousTenants": "Reconcile Previous Tenants",
   "sidebar.applyAdditionalFee": "Apply Additional Fee",
   "sidebar.applyLateFeeToAll": "Apply Late Fee to All",
   "sidebar.enterAdditionalUtilityCharge": "Enter Additional Utility Charge",
   "sidebar.tenantsPrintableDocs": "Printable Docs",
   "sidebar.allTenantsStatements": "All Tenant Statements",
   "sidebar.allDeliquentTenants": "All Deliquent Tenants",
   "sidebar.emailAllLeaseAgreements": "Email All Lease Agreements",
   "sidebar.communication": "Communication",
   "sidebar.notifyAllTenants": "Notify All Tenants",
   "sidebar.workOrders": "Work Orders",
   "sidebar.addViewWorkOrder": "Add/View",
   "sidebar.closedWorkOrder": "Closed",
   "sidebar.recurringWorkOrder": "Recurring",
   "sidebar.makeReadyBoard": "Make Ready Board",
   "sidebar.viewMakeReady": "View",
   "sidebar.reports": "Reports",
   "sidebar.marketingText": "Marketing Text",
   "sidebar.postVacancies": "Post Vacancies",
   "sidebar.supportRequest": "Support Request",
   "sidebar.suggestFeatureImprovement": "Suggest Feature Improvement",
   "sidebar.videoTutorial": "Video Tutorial",
   "sidebar.userGuide": "User Guide",
   "sidebar.FAQ": "FAQ",
   "sidebar.requestHistory": "Request History",
   "sidebar.licenseAgreement": "License Agreement",
