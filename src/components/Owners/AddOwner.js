...
const AddOwner = () => {
    ...
    const submitForm = async (data) => {
        if(parseInt(data.state) === 0) {
            NotificationManager.error("Please, select a State.", "Error.");
            return;
        }
        ...
        NotificationManager.success("Owner added!", "Success");
    }
            ...
            <div className="formelements-wrapper" style={Constants.margins}>
                ...
                <div className="row">
                    <div className="col-sm-12 col-md-12 col-xl-12">
                        <RctCollapsibleCard heading="Owner Details">
                            <Form onSubmit={handleSubmit(submitForm)}>
                                ...
                                <Button type="submit" color="primary" style={{marginTop: '10px'}}>Add Owner</Button>
                            </Form>
                        </RctCollapsibleCard>
                    </div>
                </div>
